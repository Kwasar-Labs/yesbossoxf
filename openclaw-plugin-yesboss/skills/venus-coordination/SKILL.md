...
- On YES: remember via `yesboss_set_intent` that Dr. Gill approved a check-in message
...
⚙️ Open (4): deploy, QA, docs, review
✅ Done (9)
⚠️ Blocked: deploy (Ravi, 3d no update)

Est. completion at current pace: ~3 days
...
| "what's Ravi working on?" | list_my_tasks for Ravi |
...
## Tone rules in this skill

- **Dr. Gill:** Data-first. One action offer at end. Never verbose.
- **Team members:** Warm acknowledgment. Short. Optional emoji.
- **After blocker flag to team member:** `Totally get it 😅 I've flagged it up. Dr. Gill will sort it.`
